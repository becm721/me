...
def stubborn_asker(low, high):
    ...
    """
    message = "stubborn asker asks for a number between {low}, and {high}: ".format(
        low=low, high=high
    )
    while True:
        input_number = int(input(message))
        if low < input_number < high:
            print("Thanks! {} looks okay.".format(input_number))
            return input_number
        else:
            print(
    ...
    while True:
        try:
            ...
            if low < input_number < high:
                ...
                print(
                    "err, try again {input} isn't between {low}, and {high}".format(
                        input=input_number, low=low, high=high
                    )
                )
        except Exception as e:
